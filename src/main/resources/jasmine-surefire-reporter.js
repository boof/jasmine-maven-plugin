(function() {
    ...
    /**
     * Surefire Reporter generates JUnit XML for the given spec run.
     * Allows the test results to be used in java based CI.
     * It appends some DOM elements/containers, so that a script can pick that up.
     *
     ...
     */
    var SurefireReporter =  function(consolidate, useDotNotation) {
        this.consolidate = consolidate === jasmine.undefined ? true : consolidate;
        this.useDotNotation = useDotNotation === jasmine.undefined ? true : useDotNotation;
    };

    SurefireReporter.prototype = {
        ...
        createSuiteResultContainer: function(filename, xmloutput) {
            jasmine.xmlReporterResults = jasmine.xmlReporterResults || [];
            jasmine.xmlReporterResults.push({
        ...
        createTestFinishedContainer: function(passed) {
            jasmine.xmlReporterPassed = passed

            try {
                var json = JSON.stringify(jasmine.xmlReporterResults);
                this.log('createTestFinishedContainer');
                this.log(json);
                jasmine.getGlobal().report = new java.lang.String(json);
            } catch (e) {
                this.log(e);
            }
    ...
    // export public
    jasmine.SurefireReporter = SurefireReporter;
})();